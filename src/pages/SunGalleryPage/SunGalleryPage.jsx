...
import * as sunPostsAPI from "../../utils/postApi";
import * as commentsAPI from '../../utils/likeApi';
...
export default function Feed({user, handleLogout}) {
  ...
  async function handleAddPost(post) {
    try {
      setLoading(true);
      const data = await sunPostsAPI.create(post); // our server is going to return
    ...
    <Grid centered>
      ...
      <Grid.Row>
        <Grid.Column style={{ maxWidth: 450 }}>
          <AddSunPostForm handleAddPost={handleAddPost} />
        </Grid.Column>
      </Grid.Row>
      <Grid.Row>
        <Grid.Column style={{ maxWidth: 450 }}>
